...
{
    public partial class lolvip : UserControl
    {
        public lolvip()
        {
            InitializeComponent();
        ...
        private void lolvip_Load(object sender, EventArgs e)
        {
            themecolor_Data();
            if (hardwarelabel.Text == "Not available")
            {
                hwidspoofercheckbox.Enabled = false;
            }
            else
            {
                if (hardwarelabel.Text == "Available")
                {
                    hwidspoofercheckbox.Enabled = true;
                }
            }
        }
    }
